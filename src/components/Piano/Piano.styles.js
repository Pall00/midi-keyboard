...
/**
 * New compact controls panel that slides in
 */
...
/**
 * Minimal status display bar
 */
export const MiniStatusDisplay = styled.div`
  display: flex;
  align-items: center;
...
export const MidiSection = styled.div`
  ...
  /* Override some default styles from MidiManager */
  .midi-manager-container {
    padding: 0 !important;
